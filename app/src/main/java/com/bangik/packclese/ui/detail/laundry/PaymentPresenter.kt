...
class PaymentPresenter (private val views:PaymentLaundryContract.View) : PaymentLaundryContract.Presenter {
    ...
    override fun getCheckout(
        ...
        views.showLoading()
        val disposable = HttpClient.getInstance().getApi()!!.checkoutLaundry(
            userId,
            total,
            serviceId,
            address,
