...
class PaymentPresenter(private val views: PaymentPaketContract.View):PaymentPaketContract.Presenter {
    ...
    override fun getCheckout(
        ...
        views.showLoading()
        val disposable = HttpClient.getInstance().getApi()!!.checkoutPaket(
            userId,
            total,
            serviceId,
            address,
